...
use crate::chat::first_choice;
use crate::{oa_client::OaClient, tools::AiTools};
use crate::{chat, gpts, Result};


pub async fn send_user_msg(oa_client: OaClient, ai_tools: AiTools, question: &str) -> Result<String> {
    ...
    let first_choice = first_choice(chat_response)?;
    ...
    // -- Otherwise, get/call tolls/rpc and capture the Tool Responses
    struct ToolResponse {
        tool_call_id: String,
